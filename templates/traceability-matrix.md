...
> stable IDs referenced across artifacts (see [docs/09](../docs/09-quality-and-traceability.md));
> maintain it by hand only where audit/compliance requires explicit evidence.
...
| FR-3 | <expire after 24h> | PRD §2.2 | T-4 | `test_..._FR3` | `cart.expire()` | ☐ |
