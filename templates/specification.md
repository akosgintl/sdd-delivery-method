...
> Describe **what** and **why**, not **how**. See [docs/04](../docs/04-from-needs-to-spec.md).
...
> Each requirement: a stable ID, singular, unambiguous, testable. EARS notation recommended
> (When / While / Where / If-Then / ubiquitous). See [docs/04 §4](../docs/04-from-needs-to-spec.md#4-writing-requirements-ears).
...
> Quantified. No "fast"/"secure" without numbers.
