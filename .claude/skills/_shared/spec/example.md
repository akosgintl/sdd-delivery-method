...
Originating need: PRD — Checkout Revamp §2.1 "Cart loss".
...
## 8. Data & interfaces
- Persisted entity: `Cart { userId, items[], updatedAt }`. See `design.md` §5. No new public API;
  uses existing cart service.
...
## 10. Open questions
*(empty — resolved during clarification; this spec is `ready`)*

## 11. Rationale / decisions
- 24-hour expiry chosen to balance convenience against stale-price/stock risk; see ADR-0007.
